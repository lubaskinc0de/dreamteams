...
from posutochnik.adapters.db.alembic.config import get_alembic_config_path
from posutochnik.bootstrap.fast_api import run_api
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="posutochnik",
        description="posutochnik CLI Tool",
