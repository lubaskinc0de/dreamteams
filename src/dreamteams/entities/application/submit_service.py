...
def submit_application(  # noqa: PLR0913
    ...
    if competition.participant_type not in {ParticipantType.ANY, participant.participant_type}:
    ...
    return application_factory(data=data, participant=participant, competition=competition, clock=clock, form=form)
