...
from tests.integration.exporter.fake_gateways import FakeDreamTeamsApiClient
...
class ExporterTestOverridesProvider(Provider):
    ...
    dreamteams_api_client = provide(FakeDreamTeamsApiClient, provides=DreamTeamsApiClient)
