...
/**
 * Features section with feature cards grid
 */
...
<template>
  <section class="relative py-12 sm:py-16 md:py-20 overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-primary-50/50 via-white to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"></div>
    ...
    <UContainer class="relative z-10">
      <div class="text-center mb-8 sm:mb-12 md:mb-16 fade-in-scroll">
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-3 sm:mb-4">
        ...
        >
          <template #header>
            <div class="flex items-center gap-3 sm:gap-4">
              <div class="p-2 sm:p-3 rounded-xl bg-gradient-to-br from-primary-500/15 to-primary-400/10">
