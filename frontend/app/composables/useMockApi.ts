...
const mockPreviewCompetitions: PreviewCompetitionModel[] = [
  {
    ...
    participant_limits: { min: 100, max: 500 },
    domains: ["ai", "backend"],
  ...
  },
  {
    ...
    participant_limits: { min: 40, max: 180 },
  ...
  },
  {
    ...
    participant_limits: { min: 25, max: 100 },
    domains: ["frontend", "ai"],
    participant_type: "student",
  ...
  },
  {
    ...
    participant_limits: { min: 20, max: 80 },
  ...
  },
  {
    ...
    participant_limits: { min: 50, max: 250 },
  ...
  },
  {
    ...
    participant_limits: { min: 30, max: 120 },
  ...
  },
  {
    ...
    participant_limits: { min: 40, max: 200 },
    domains: ["frontend", "backend"],
    participant_type: "any",
    venue: { format: "online", location: null },
    team_size: { min: 2, max: 4 },
